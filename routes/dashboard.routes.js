...
/**
 * @swagger
 * /api/dashboard/demandeur/stats:
 *   get:
 *     summary: Stats dashboard DEMANDEUR
 *     tags: [Dashboard]
 *     parameters:
 *       - in: query
 *         name: recentDays
 *         schema: { type: integer, minimum: 0 }
 *         description: Fenêtre (jours) pour les métriques récentes (défaut 30)
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200: { description: Données demandeur }
 *       403: { description: Accès refusé }
 *       500: { description: Erreur serveur }
 */
router.get(
    '/:userId/demandeur/stats',
    requireAuth,
    ctrl.getDemandeurDashboardStats
);

/**
 * @swagger
 * /api/dashboard/institut/stats:
 *   get:
 *     summary: Stats dashboard INSTITUT
 *     tags: [Dashboard]
 *     parameters:
 *       - in: query
 *         name: recentDays
 ...
 */
router.get(
    '/:organizationId/institut/stats',
    requireAuth,
    ctrl.getInstitutDashboardStats
);

/**
 * @swagger
 * /api/dashboard/traducteur/stats:
 *   get:
 *     summary: Stats dashboard TRADUCTEUR
 *     tags: [Dashboard]
 *     parameters:
 *       - in: query
 *         name: recentDays
...
router.get(
    '/traducteur/stats',
    requireAuth,
    ctrl.getTraducteurDashboardStats
);
